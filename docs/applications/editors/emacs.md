...
<!-- emacs, 或vim, 在我看来最大的问题在于0基础入门的难度，小白看到一个连怎么保存退出都不会的编辑器第一反应只会是“早有耳闻，原来这么难”、“我不适合这个”等。写这篇教程想的理念是，一般用户怎么用nano，windows记事本，我们就教他相同的操作在emacs里怎么做，不涉及概念，不涉及架构，甚至不指望小白能记住所有快捷键。我想把emacs“去神化”，告诉他们一般人也能用emacs。只要证明了最基础的，能像nano一样使用emacs，一部分人就会留下，想着然后学习怎么更好地使用emacs。就像Linux。
感谢正在审稿的维护者能理解我的观点。
